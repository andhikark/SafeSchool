...
class NotReviewed extends StatefulWidget {
  const NotReviewed({super.key});

  @override
  State<NotReviewed> createState() => _NotReviewedState();
}

class _NotReviewedState extends State<NotReviewed> {
            ...
            child: Column(
              ...
              children: reports.map((report) {
                return ReportCard(
                  ...
                  date: report.dateOfIncident.split('T')[0],
                );
              }).toList(),
            ),
          );
